...
import third_person_man.utils.transform_utils as transform_utils # Taken from deoxys
from .prep_module import PreprocessorModule
from holobot.robot.allegro.allegro_kdl import AllegroKDL

from third_person_man.utils import MODALITY_TYPES
...
class RobotPreprocessor(PreprocessorModule):
    def __init__(self,
        ...
        print('robot files: {}'.format(self.robot_files))
    ...
    def load_data(self):
        ...
        for robot_type in self.robot_types:
            ...
            if robot_type == 'hand':
                with h5py.File(
                    ...
                    print('f.keys: {}, file name: {}'.format(f.keys(), self.robot_files['load'][robot_type][0]))
        ...
        print('robot hand times: {}'.format(self.data['hand']['timestamps']))
