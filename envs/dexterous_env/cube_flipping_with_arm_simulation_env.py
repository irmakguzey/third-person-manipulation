...
class CubeFlippingArmEnv(DexterousSimulationEnv):
    def __init__(self): 
        super().__init__()
    ...
    def set_home_state(self):  
        ...
        self.endeff_home_state = torch.tensor([0.2, 1.5, -0.3, 0, 0, 0, 1]) 

    def load_urdfs(self): 
        print('** Loading URDFs **')
        actor_asset_file = "allegro_hand_description/urdf/model_new_connected.urdf"
    ...
    def create_camera_sensors(self): 
        ...
        camera_position = gymapi.Vec3(1.18, 3.3, -0.5)
